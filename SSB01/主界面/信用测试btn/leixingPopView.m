...
{
    _PopBorderColor5 = PopBorderColor;
...
{
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(chooseButton5:)]) {
        [self.delegate chooseButton5:sender.titleLabel.text];
        [self showPopView5];
    }
}
/**
